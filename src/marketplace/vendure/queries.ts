...
export const GetActiveOrderForCheckoutQuery = gql`
...
export const GetEligibleShippingMethodsQuery = gql`
...
export const GetEligiblePaymentMethodsQuery = gql`
...
export const GetAvailableCountriesQuery = gql`
